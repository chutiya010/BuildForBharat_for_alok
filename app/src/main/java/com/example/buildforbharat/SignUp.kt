...
import com.example.buildforbharat.LandingPage
import com.example.buildforbharat.databinding.ActivitySignUpBinding
...
class SignUp : AppCompatActivity() {
        ...
        binding.signupbtn.setOnClickListener {
            ...
            if (name.isNotEmpty() && phone.isNotEmpty() && username.isNotEmpty() && email.isNotEmpty() && pass.isNotEmpty() && confpass.isNotEmpty()) {
                ...
                GlobalScope.launch() {
                    ...
                    loginlate(pass,confpass, email,username)
    ...
    private fun loginlate(pass: String,confpass:String,email: String,username: String){
        if (pass == confpass) {
